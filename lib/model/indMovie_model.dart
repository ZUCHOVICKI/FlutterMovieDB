...
//
//     final indMovie = indMovieFromMap(jsonString);
...
class IndMovie {
  ...
  factory IndMovie.fromJson(String str) => IndMovie.fromMap(json.decode(str));

  String toJson() => json.encode(toMap());

  factory IndMovie.fromMap(Map<String, dynamic> json) => IndMovie(
        adult: json["adult"],
